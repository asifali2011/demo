...
public class RequestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(
		...
		final ApiResponse apiResponse = new ApiResponse(HttpStatus.METHOD_NOT_ALLOWED.value(), "Method Not Allowed",
				builder.toString());
		return new ResponseEntity<>(apiResponse, new HttpHeaders(), HttpStatus.METHOD_NOT_ALLOWED);
	}
	...
	protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(final HttpMediaTypeNotSupportedException ex,
		...
		return new ResponseEntity<>(apiResponse, new HttpHeaders(), HttpStatus.UNSUPPORTED_MEDIA_TYPE);
	}
